...
export const signUpSchema = loginSchemaEmail.extend({
  username: z.string().min(3, "Username must me greater than 3 characters").max(25, "Username must be under 25 characters").refine(value => specialCharacters.test(value), {message: "Username should not contain special characters"})
  ,
});
